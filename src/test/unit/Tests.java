...
public class Tests {
	 ...
	 */
	@Test
	public void testDjiboutiNoRotation() throws SegmentBalanceException, BalancerException, TerminalParseException {
	...
	public boolean testDjiboutiN(int n, int rot)
			throws SegmentBalanceException, BalancerException, TerminalParseException {
	...
	public Collection<DynamicTest> djboutiDynamicTests() {
		...
		for (int i = n - 1; i < n; i++) {
			...
			int num = a[i];
			// 7: something wrong with knot detection. I think the thing I had before about
			// the runs turning into knots if both end pointed internally was the correct
			// thing
			...
			for (int j = 7; j < limit; j++) {
				...
				DynamicTest dTest = DynamicTest.dynamicTest(testName,
						() -> Assert.assertEquals(true, testDjiboutiN(n, rot)));
	...
	@Test
	public void testQatar() throws SegmentBalanceException, BalancerException, TerminalParseException {
	...
	@Test
	public void testWesternSahara() throws SegmentBalanceException, BalancerException, TerminalParseException {
