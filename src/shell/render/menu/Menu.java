...
public class Menu {
    ...
    public void draw(float zIndex) {
        ...
        for (int i = 0; i < menuItems.size(); i++) {
            menuOuterBorder.drawCentered(Canvas3D.frameBufferWidth / 2,
                    Canvas3D.frameBufferHeight / 2 - menuOuterBorder.outerTexture.height * scale / 2 * i * 1.5f, scale,
                    zIndex,
                    new Color(Color.NAVY, 0.8f));
        }
    }
