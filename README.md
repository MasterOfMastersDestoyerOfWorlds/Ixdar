<img src="decal.svg" alt="Decal" width="85%" style="display: block;margin-left: auto;margin-right: auto;"/>
...
[Chapter 5: On the Nature of Abstraction](#chapter-5)
...
a natural abstraction is one in which the elements of the sets described interact more with other elements of the abstraction's set than with objects outside the set.
