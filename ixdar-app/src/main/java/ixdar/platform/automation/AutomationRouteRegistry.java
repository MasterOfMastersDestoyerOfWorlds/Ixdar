...
/**
 * Registers methods annotated with {@link AutomationRoute} as HTTP handlers.
 * A handler method must return {@link JsonObject} and accept either () or (JsonObject body).
 * GET routes call the no-arg form; POST routes read and parse the request body first.
 */
