...
public class MinimumSpanningTreeNode implements MeshNode {
    ...
    public Map<String, String> socketDocs() {
        return Map.of(
                ...
                "rooms", "Room list used to weight edges by center-to-center distance.",
                "extra_edge_prob", "Probability [0,1] of keeping each non-MST edge as a loop (default 0.125 per vazgriz).",
                "seed", "Seed for the extra-edge RNG stream (separate from upstream room placement)."
        );
    }
