...
public class MinimumSpanningTreeNode implements MeshNode {
    ...
    public Map<String, String> socketDocs() {
        return Map.of(
                EDGES, "Candidate edges (typically from delaunay_graph).",
                ROOMS_2, "Room list used to weight edges by center-to-center distance.",
                EXTRA_EDGE_PROB_2, "Probability [0,1] of keeping each non-MST edge as a loop (default 0.125 per vazgriz).",
                SEED_2, "Seed for the extra-edge RNG stream (separate from upstream room placement)."
        );
    }
