 ...
 * {@link ixdar.geometry.mesh.quadlayout.crossfield.CrossField} on a triangle
 * mesh. Loads the OFF specified by {@code -DcrossFieldScene.off=<path>}
 * (default {@link #DEFAULT_OFF}), runs the cross-field generator, and renders
