...
/**
 * The {@code Point2D} class defines a point representing a location in
...
public abstract class Point2D implements Cloneable {
    ...
    /**
     * Sets the location of this {@code Point2D} to the specified {@code double}
     * coordinates.
     *
     * @param x the new X coordinate of this {@code Point2D}
     * @param y the new Y coordinate of this {@code Point2D}
    ...
    /**
     * Returns the square of the distance from this {@code Point2D} to a specified
     * point.
     *
     * @param px the X coordinate of the specified point to be measured against this
     *           {@code Point2D}
     * @param py the Y coordinate of the specified point to be measured against this
     *           {@code Point2D}
     * @return the square of the distance between this {@code Point2D} and the
     *         specified point.
     * @since 1.2
     */
     ...
     * {@code Point2D}.
     *
     * @param pt the specified point to be measured against this {@code Point2D}
     * @return the square of the distance between this {@code Point2D} to a
    ...
    /**
     * Returns the distance from this {@code Point2D} to a specified point.
     *
     * @param px the X coordinate of the specified point to be measured against this
     *           {@code Point2D}
     * @param py the Y coordinate of the specified point to be measured against this
     *           {@code Point2D}
     * @return the distance between this {@code Point2D} and a specified point.
     * @since 1.2
     */
    ...
    /**
     * Returns the distance from this {@code Point2D} to a specified
     * {@code Point2D}.
     *
     * @param pt the specified point to be measured against this {@code Point2D}
     * @return the distance between this {@code Point2D} and the specified
     *         {@code Point2D}.
     * @since 1.2
     */
